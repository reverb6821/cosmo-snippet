...
import { router } from './src/routes/router' //! router import
import * as errorHandler from './src/services/errorHandler' //! handler error import
import morganMiddleware from './src/lib/morganMiddleware' //! custom middleware for morgan
import Logger from './src/lib/logger' //! custom logger builded with winston
